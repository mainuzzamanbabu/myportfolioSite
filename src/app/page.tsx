  ...
  return (
    <motion.nav 
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled ? "nav-glass py-2 shadow-lg" : "bg-transparent py-4"
      }`}
    >
...
function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-24 pb-12 lg:pt-28 lg:pb-16 overflow-hidden">
      {/* Floating orbs */}
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap gap-4 justify-center lg:justify-start ml-0 mb-12 lg:mb-10">
            ...
            {/* Social Links */}
            <motion.div variants={fadeInUp} className="flex gap-3 mt-6 lg:mt-4 justify-center lg:justify-start ml-0">
              {[
